...
!(function (e, t) {
  ...
  class Pi extends Xt {
    ...
    connectedCallback() {
      ...
      (this.isParentLayout = a(e, "mdui-layout")),
        this.isParentLayout &&
          ((this.layoutManager = Mi(e)), this.layoutManager.registerItem(this));
    }
    disconnectedCallback() {
      super.disconnectedCallback(),
  ...
  const Ui = (e) => {
    class t extends e {
      renderAnchor({
        ...
        return ft`<a ${n} id="${Ft(e)}" class="_a ${t || ""}" part="${Ft(
          i
        )}" href="${Ft(this.href)}" download="${Ft(
          this.download
        )}" target="${Ft(this.target)}" rel="${Ft(this.rel)}" tabindex="${Ft(
          r
        )}">${o}</a>`;
      }
    }
  ...
  (e.Checkbox = class extends Xi(ji(Xt)) {
    ...
    render() {
      return ft`<label class="${Wi({ invalid: this.invalid })}"><input ${zi(
        this.inputRef
      )} type="checkbox" name="${Ft(this.name)}" value="${Ft(
        this.value
      )}" .indeterminate="${io(this.indeterminate)}" .disabled="${
        this.disabled
      }" .checked="${io(this.checked)}" .required="${this.required}" @change="${
        this.onChange
      }"> <i part="control"><mdui-ripple ${zi(this.rippleRef)} .noRipple="${
        this.noRipple
    ...
    if (e) {
      const o =
          ...
          (function (e) {
            ...
            let i = Vo.get(t);
            void 0 === i &&
              ((i = No(t, "string" != typeof e && !("strTag" in e))),
              Vo.set(t, i));
            return i;
          })(t),
        n = e[o];
  ...
  (e.Dialog = class extends Xt {
    ...
    async onOpenChange() {
      ...
      if (this.open) {
        ...
        await Promise.all([
          bo(this.overlayRef.value, [{ opacity: 1 }, { opacity: 0 }], {
            duration: e,
            easing: i,
          }),
          bo(
  ...
  function yn(e) {
    ...
    const t =
      ...
      (function (e) {
        var t;
        return null ==
          (t = (vn(e) ? e.ownerDocument : e.document) || window.document)
          ? void 0
          : t.documentElement;
      })(e);
  ...
  function wn(e) {
    ...
    return (function (e) {
      ...
      ? e.ownerDocument
        ...
        : e.body
      : ((i = t) instanceof HTMLElement || i instanceof fn(i).HTMLElement) &&
        bn(t)
      ? t
      : wn(t);
    var i;
  ...
  (e.LayoutMain = class extends Xt {
    connectedCallback() {
      ...
      const e = this.parentElement;
      a(e, "mdui-layout") &&
        ((this.layoutManager = Mi(e)), this.layoutManager.registerMain(this));
    }
    disconnectedCallback() {
      super.disconnectedCallback(),
  ...
  (e.TextField = class extends ji(Xt) {
    ...
    renderInput(e) {
      return ft`<input ${zi(this.inputRef)} part="input" class="input ${Wi({
        ...
        this.minlength
      )}" maxlength="${Ft(this.maxlength)}" min="${Ft(this.min)}" max="${Ft(
        this.max
      )}" step="${Ft(this.step)}" autocapitalize="${Ft(
    ...
    render() {
      ...
      return ft`${
        this.multiple
          ? ft`<select ${zi(
              this.hiddenInputRef
            )} class="hidden-input" name="${Ft(this.name)}" value="${Ft(
              this.value
  ...
  (e.Slider = class extends Wn {
    ...
    render() {
      return ft`<label class="${Wi({ invalid: this.invalid })}"><input ${zi(
        ...
        this.max
      }" ?disabled="${this.disabled}" .value="${io(
        this.value.toString()
    ...
    connectedCallback() {
      super.connectedCallback(),
        ...
        (this.observeResize = Ti(document.documentElement, async () => {
          ...
          this.mobile !== e &&
            ((this.mobile = e),
            rr || ((rr = !0), await this.reorderStack(), (rr = !1)));
        }));
    }
    disconnectedCallback() {
      super.disconnectedCallback(),
  ...
  (e.Switch = class extends Xi(ji(Xt)) {
    ...
    render() {
      return ft`<label class="${Wi({
        ...
        this.name
      )}" value="${Ft(this.value)}" .disabled="${this.disabled}" .checked="${io(
        this.checked
  ...
  const kr = (t) => {
      ...
      return (
        ...
        o.appendTo("body").on("closed", (e) => {
          e.target === i &&
            (o.remove(), t.queue && ((wr = void 0), gr(yr + t.queue)));
        }),
        t.queue
          ? wr
            ? vr(yr + t.queue, () => {
  ...
  class Qr {
    static ratioOfTones(e, t) {
      return (
        (e = Sr(0, 100, e)), (t = Sr(0, 100, t)), Qr.ratioOfYs(Hr(e), Hr(t))
      );
    }
    ...
    getTone(e) {
      ...
      }
      {
        ...
        if (
          ...
          if (Qr.ratioOfTones(a, i) >= n && Qr.ratioOfTones(l, i) >= n)
            return i;
  ...
  (cs.contentAccentToneDelta = 15),
    ...
    (cs.secondaryFixed = ts.fromPalette({
      ...
      contrastCurve: new ns(1, 1, 3, 4.5),
      toneDeltaPair: (e) =>
        new rs(cs.secondaryFixed, cs.secondaryFixedDim, 10, "lighter", !0),
    })),
    ...
    (cs.tertiaryFixed = ts.fromPalette({
      ...
      contrastCurve: new ns(1, 1, 3, 4.5),
      toneDeltaPair: (e) =>
        new rs(cs.tertiaryFixed, cs.tertiaryFixedDim, 10, "lighter", !0),
    })),
  ...
  class Es {
    ...
    static score(e, t) {
      ...
      for (const e of r) {
        ...
        if (
          n &&
          (e.chroma < Es.CUTOFF_CHROMA || t <= Es.CUTOFF_EXCITED_PROPORTION)
        )
          continue;
      ...
      for (let e = 90; e >= 15; e--) {
        ...
        for (const { hct: t } of c) {
          if ((d.find((i) => Dr(t.hue, i.hue) < e) || d.push(t), d.length >= i))
            break;
        }
        if (d.length >= i) break;
      }
  ...
  (e.$ = M),
    ...
    (e.snackbar = (t) => {
      ...
      return (
        ...
        o.appendTo("body").on("closed", (e) => {
          e.target === i &&
            (o.remove(), t.queue && ((Ns = void 0), gr(zs + t.queue)));
        }),
        t.queue
          ? Ns
            ? vr(zs + t.queue, () => {
